...
import com.spring.smart_stay_hotel.repository.RoomRepository;
...
public class RoomServiceImpl implements RoomService {
    ...
    @Override
    public Room update(Long roomId, String roomType, BigDecimal roomPrice, byte[] photoBytes) throws InternalServerException {
